 ...
 * @author danda
 */
public class FrameCadastroRestaurante extends javax.swing.JFrame {

    /**
     * Creates new form FrameCadastro
     */
    public FrameCadastroRestaurante() {
        try {
            initComponents();
            ...
            Logger.getLogger(FrameCadastroRestaurante.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Escolha uma categoria inicial (você poderá alterá-la e adicionar outras futuramente)");
    ...
    private void btnCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastroActionPerformed
        try {
            ...
            if(BD.selectEmailUsadoRestaurante(fldEmail.getText())){
                JOptionPane.showMessageDialog(null, "Já existe cadastro com esse e-mail.");
            }else{
                
                ID.insereRestaurante(fldNome.getText(), fldEmail.getText(), senhaString, 0, 1, fldEndereco.getText());
                
                String selecionada = "" + boxCategorias.getSelectedItem();
                int id_categoria = BD.selectIDCategoria(selecionada);
                ResultSet rs = BD.selectRestauranteExiste(fldEmail.getText(), senhaString);
                int id_restaurante = rs.getInt("id_restaurante");
                rs.close();
                
                ID.inserePertencimento(id_restaurante, id_categoria);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameCadastroRestaurante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
